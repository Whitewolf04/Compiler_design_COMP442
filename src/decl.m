...
LINEAR::constructor	nop
	...
	addi r1,r0,0
	addi r1,r0,0	% Get offset of member variable a
	addi r1,r0,-8	% Get offset of member variable a in object
	sw objectOffsetBuf(r0),r1
% Assigning A to self.a
	lw r1,0(r13)
	sw objectOffsetBuf(r13),r1
...
% Calling member function QUADRATIC::constructor
	lw r1,-36(r13)(r13)	% Load parameter t11
...
% Calling member function LINEAR::evaluate
	lw r1,-20(r13)	% Load parameter counter
	lw r12,f1(r0)	% Load object address onto r12
	jl r15,LINEAR::evaluate
	lw r8,0(r13)	% Load return value onto r8
	addi r13,r13,36
	addi r14,r14,36
	sw funcReturnBuf(r0),r8
% Printing funcReturnBuf to console
	lw r10,funcReturnBuf(r0)
	jl r15,putint
% Calling member function QUADRATIC::evaluate
	lw r1,-20(r13)	% Load parameter counter
	lw r12,f2(r0)	% Load object address onto r12
	jl r15,QUADRATIC::evaluate
	lw r8,0(r13)	% Load return value onto r8
	addi r13,r13,48
	addi r14,r14,48
	sw funcReturnBuf(r0),r8
